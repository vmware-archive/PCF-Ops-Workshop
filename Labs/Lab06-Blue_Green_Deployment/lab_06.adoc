...
[abstract]
--
PCF allows users to easily conduct zero-downtime application upgrades using blue/green deployments.
...
$ cf push 
----
. Use the CLI to verify that you now have two different "Hello World" applications deployed to PCF using the below command.  
+
----
$ cf apps
----
