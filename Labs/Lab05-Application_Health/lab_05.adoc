...
. In your browswer, navigate to http://metrics.<DOMAIN-PROVIDED-BY-INSTRUCTOR>.  You may be asked to sign in again with your user id and password.
...
To better meet the needs of operators, Cloud Foundry provides the ability to http://docs.cloudfoundry.org/devguide/services/log-management.html[drain logs to third-party providers.]
