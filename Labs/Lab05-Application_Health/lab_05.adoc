...
Before we move forward with lab work, let's exmaine the imbeddeed monitoring tool called PCF Metrics. 

In your browswer, navigate to your application's page. From there click on the link that says "View in PCF Metrics".

This will bring you to the PCF Metrics page for that application. The dashboard will give you a great overview of how your application is behaving. As we continue through the lab, you can peridoically check back to this page and you can see in real time how the application is monitored by PCF Metrics.
